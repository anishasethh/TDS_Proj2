...
def GA1_13(question):
    ...
    return "https://raw.githubusercontent.com/anishasethh/main/email.json"
...
async def GA2_6_file(file: UploadFile = File(...)):
    ...
    response = github_write_file(
        token, "anishasethh/api", file_path_on_github, file_content)
...
async def GA2_9_file(file: UploadFile = File(...)):
    ...
    # Upload the file to GitHub
    response = github_write_file(
        token, "anishasethh/ga2_9", file_path_on_github, file_content)
